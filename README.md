# Weather Dashboard - Github Repo password-manager https://github.com/Evans20kom/weather-dashboard
...
When you open the deployed application [here](https://evans20kom.github.io/weather-dashboard/), a page with prompts will appear that you can manipulate to generate a random password:
